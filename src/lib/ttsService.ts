...
const EMOTION_CONFIGS: Record<EmotionType, TTSConfig> = {
  neutral: { rate: 1.05, pitch: 1.15, volume: 1.0 },
  happy: { rate: 1.15, pitch: 1.35, volume: 1.0 },
  excited: { rate: 1.35, pitch: 1.55, volume: 1.0 },
  curious: { rate: 1.1, pitch: 1.3, volume: 1.0 },
  shy: { rate: 0.85, pitch: 1.25, volume: 0.85 },
  sad: { rate: 0.8, pitch: 0.95, volume: 0.8 },
  funny: { rate: 1.3, pitch: 1.5, volume: 1.0 },
  annoyed: { rate: 1.3, pitch: 1.1, volume: 1.0 },
